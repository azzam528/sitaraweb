<script src="./PatientAddView.js"></script>
    ...
    <div class="modal-overlay" v-if="showSuccessModal">
      <div class="modal-content">
        ...
        <div v-if="createAccount" class="whatsapp-success">
          ...
          <div>
            <h4>Akun Pasien Berhasil Dibuat</h4>
            <p class="mb-2">Kredensial login aplikasi mobile/web pasien:</p>
            <div style="background: rgba(0,0,0,0.06); padding: 8px 12px; border-radius: 6px; font-family: monospace; font-size: 13px;">
        ...
        <button class="btn btn-primary btn-block mt-4" @click="finishAndRedirect">Kembali ke Daftar Pasien</button>
      </div>
    </div>
  </div>
</template>
