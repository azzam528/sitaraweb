...
<!-- Right Column: AI Analysis + Verification Actions -->
      ...
      <!-- 4. Reviewer Notes Card (Full Width with Auto-save) -->
      <div class="card notes-card">
        <div class="notes-header-row mb-2">
          <div class="card-title-with-icon">
            <svg xmlns="http://www.w3.org/2000/svg" class="title-icon text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <div v-if="saveStatus" class="notes-save-indicator" :class="'save-' + saveStatus">
            <span v-if="saveStatus === 'saving'" class="save-status-text">
              <span class="save-spinner"></span> Menyimpan...
            </span>
            <span v-else-if="saveStatus === 'saved'" class="save-status-text">
              <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                <polyline points="20 6 9 17 4 12"></polyline>
              </svg>
              Tersimpan
            </span>
            <span v-else-if="saveStatus === 'error'" class="save-status-text">
