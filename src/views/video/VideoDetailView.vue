      ...
      <div class="row-grid">
        ...
        <div class="col-side">
          ...
          <div class="card action-card">
            ...
            <!-- Ketika status pending: Tampilkan tombol Setujui, Tinjau Ulang, Tolak -->
            <div
              v-if="videoData.status === 'pending' || videoData.status === 'Menunggu Tinjauan' || videoData.status === 'review'"
            ...
            <!-- Status Final (verified / rejected) -->
            <div v-else class="verified-status-info">
              ...
              <p class="status-helper-text">
                Verifikasi video ini telah selesai diproses dan berstatus <strong>{{ formatStatus(videoData.status) }}</strong>.
              </p>

              <!-- Hubungi Pasien via WhatsApp tetap ada -->
              <button
                v-if="videoData.patient?.phone"
